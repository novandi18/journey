...
import com.novandi.journey.presentation.viewmodel.JobProviderPasswordViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun JobProviderPasswordScreen(
    viewModel: JobProviderPasswordViewModel = hiltViewModel(),
