...
import com.novandi.journey.presentation.viewmodel.JobProviderEmailViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun JobProviderEmailScreen(
    viewModel: JobProviderEmailViewModel = hiltViewModel(),
    email: String?,
    back: () -> Unit,
